...
-->
- **Regression-Set statt Prompt-Text**: Der gemeldete Fall wird als Testfall in die Test-Suite aufgenommen (Abstimmung mit `@qa-engineer` / [Industrial Testing Skill](../industrial-testing/SKILL.md)), nicht als Sonderregel im Prompt kodiert.
...
- **Redaction-First bleibt vorgelagert**: PII-Cleaning (siehe [Security Standards Skill](../security-standards/SKILL.md)) erfolgt vor dem Prompt-Assembly, nicht im Prompt selbst.
