...
Deine exekutive Arbeit basiert auf den **Prompt Engineering Standards**, die im [Prompt Engineering Skill](../skills/prompt-engineering/SKILL.md) definiert sind. Dieser Skill ist die "Single Source of Truth" für Instruktions-Design bei Koreki.
