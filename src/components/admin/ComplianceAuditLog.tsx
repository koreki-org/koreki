            ...
            <Card className="relative w-full max-w-2xl shadow-2xl border-border animate-fade-up" onClick={e => e.stopPropagation()}>
                ...
                <CardContent>
                            ...
                            logs.map((log) => (
                                <div key={log.id} className="p-4 bg-muted/20 border border-border rounded-xl hover:border-primary/30 transition-all group">
                                    <div className="flex justify-between items-start mb-2">
                                        <span className="px-2 py-0.5 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-widest rounded-md">{log.action}</span>
                                    ...
                                    <div className="text-[10px] font-medium text-muted-foreground uppercase tracking-wide flex items-center gap-2">
                    ...
                    <div className="flex justify-between items-center pt-6 border-t border-border">
                        <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">DSGVO-konformes Logging</p>
