...
export const FeatureHero: React.FC = () => {
    return (
        <section className="pt-16 pb-12 md:pt-hero-top md:pb-hero-bottom px-6 md:px-page-inline text-center bg-gradient-to-b from-white to-muted/50">
            <div className="max-w-[900px] mx-auto">
                <h1 className="text-5xl md:text-6xl font-black text-foreground mb-6 tracking-tight leading-tight">
                    Intelligenz trifft <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-1 to-accent-2">volle Flexibilität.</span>
                </h1>
