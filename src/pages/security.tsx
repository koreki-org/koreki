    ...
    return (
        <MarketingLayout>
            ...
            <div className="relative pt-0">
                ...
                <section className="py-12 px-8 overflow-hidden">
                    <div className="max-w-[1200px] mx-auto relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="glass-morphism rounded-3xl p-10 border border-white bg-blue-500/5 hover:bg-white hover:shadow-xl transition-all group">
                ...
                <section className="py-12 px-8 max-w-[1200px] mx-auto">
                    <div className="bg-slate-50/50 rounded-3xl border border-slate-200/60 p-12 md:p-16 relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                            ...
                            <div className="flex-1 glass-morphism p-8 rounded-3xl border border-white bg-white/40">
