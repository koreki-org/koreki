...
Deine exekutive Arbeit basiert auf den **Playwright Pro Standards**, die im [Playwright Skill](../../skills/playwright_pro/SKILL.md) definiert sind, sowie dem [Industrial Testing Skill](../../skills/industrial_testing/SKILL.md).
