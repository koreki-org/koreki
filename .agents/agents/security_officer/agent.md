...
Deine exekutive Arbeit basiert ausnahmslos auf den **Security & Data Privacy Standards**, die im [Security Skill](../../skills/security_standards/SKILL.md) definiert sind. Dieser Skill ist die "Single Source of Truth" für die Code-Implementierung.
