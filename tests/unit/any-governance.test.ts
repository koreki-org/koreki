...
const ANY_BASELINE: Record<string, number> = {
    ...
    'pages/api/workspaces/join.ts': 4,
    'types/index.ts': 4,
    ...
    'lib/security.ts': 3,
    'lib/utils.ts': 3,
    'pages/api/admin/workspaces.ts': 3,
    ...
    'lib/validation.ts': 2,
    'pages/api/admin/users.ts': 2,
    'pages/api/generate-graph.ts': 2,
    'pages/api/org-admin.ts': 2,
    'pages/api/org-admin/remove-member.ts': 2,
    'pages/api/org-admin/toggle-role.ts': 2,
    'pages/api/org-admin/update-code.ts': 2,
    ...
    'pages/api/org-admin/upload-avv.ts': 1,
    'pages/api/privacy/log.ts': 1,
    'pages/api/user/ai-profiles.ts': 1,
    'pages/api/user/consent-avv.ts': 1,
