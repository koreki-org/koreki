...
const DUPLICATION_BASELINE: Record<string, number> = {
    ...
    'pages/api/second-opinion.ts <-> pages/api/user/grading-memories/anonymize.ts': 6,
    'pages/api/user/grading-memories/anonymize.ts <-> pages/api/user/grading-memories/generate.ts': 10,
