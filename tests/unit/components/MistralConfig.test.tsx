...
describe('MistralConfig (Layer 2 - Vault Integration)', () => {
    ...
    it('should call vaultService when saving a key in Desktop mode', async () => {
        ...
        fireEvent.change(input, { target: { value: 'sk-new-valid-key-123456789' } });
        
        const saveButton = screen.getByText(/Speichern/i);
        fireEvent.click(saveButton);
        
        await waitFor(() => {
            expect(vaultService.saveSecret).toHaveBeenCalledWith('koreki-mistral-key', 'sk-new-valid-key-123456789');
        });
    });
