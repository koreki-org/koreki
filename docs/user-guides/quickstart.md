...
### 4a. Das Expert Center: Expertise, Skills, Erfahrungsschatz & Intelligenz
Im **Expert Center** (oben rechts in der Menüleiste) stellst du die vier tragenden Säulen deiner KI-Korrektur ein:
...
2. **Skills (Kriterienkataloge):** Strukturiere deine Korrektur mit wiederverwendbaren Kompetenzbereichen. Lege pro Aufgabe spezifische Skills fest (z. B. Rechenketten, Textästhetik, Korrekturzeichen), um extrem differenzierte und konsistente Auswertungen für jeden Schüler zu erhalten.
3. **Erfahrungsschatz (GradingMemory):** Hier kalibrierst du das fallbasierte Gedächtnis deiner KI. Hinterlege reale oder beispielhafte Korrekturfälle, damit die KI aus deinen früheren Bewertungen lernt und Folgefehler oder mathematische Äquivalenzen absolut konsistent nach deinen eigenen Maßstäben bewertet.
4. **Intelligenz (KI-Parameter):** Steuere die Leistungskraft und Denkweise der KI. Aktiviere hier das **Deep Thinking (Hohe Genauigkeit)** für komplexe mathematische oder logische Prüfungen, oder passe Parameter wie die *Kreativität (Temperature)* an.
   > [!TIP]
